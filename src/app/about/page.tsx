...
export default function AboutPage() {
  ...
  return (
    <div ref={pageRef}>
      ...
      >
        <Image
          src="/assets/serve-sign-hedge.webp"
      ...
      <section className="relative overflow-hidden section-padding-sm">
        ...
        <Image
          src="/assets/botanical-mural.webp"
          alt="Tropical botanical mural background"
          fill
          className="object-cover object-center"
          sizes="100vw"
        />
      ...
      <section className="section-padding-sm px-6" style={{ backgroundColor: 'var(--serve-green)' }}>
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="text-center mb-16 lg:mb-20">
            <p className="label-overline text-white opacity-60 mb-4 fade-up" style={{ color: 'var(--serve-cream)' }}>
              What we stand for
            </p>
            <h2
